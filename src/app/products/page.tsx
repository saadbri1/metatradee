    ...
    <PublicShell>
      ...
      >
        <div className="flex flex-wrap gap-3">
          <Link
            href="/register"
            className="h-13 inline-flex items-center rounded-xl bg-gradient-to-r from-primary to-iris px-8 py-3.5 text-base font-semibold text-primary-foreground shadow-[0_12px_28px_-14px_hsl(var(--primary)/0.85)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
            Get Started
          </Link>
          <Link
